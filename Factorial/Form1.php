...
<table width="800" height="780" border="20" align="center" cellpadding="15" cellspacing="10" bgcolor="#ac5353">
    <tr>
        <form name="form1" method="post" action="Factorial.php">
            <td>
                <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6666ff">
                    ...
                    <tr>
                        <td width="350">Please Enter a number which you want to calculate factorial</td>
                        <td width="60">:</td>
                    ...
                    <!--<tr>
                        <td width="350">The factorial of given number is : </td>
                        <td width="60">:</td>
